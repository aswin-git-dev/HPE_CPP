...
_FALCO_ACTION_BY_RULE: Dict[str, str] = {
    ...
    "find aws credentials": "Searched cloud credentials",
    "find gcp credentials": "Searched cloud credentials",
...
_FALCO_ACTION_RULE_HINTS: List[tuple[str, str]] = [
    ...
    ("aws credentials", "Searched cloud credentials"),
    ("gcp credentials", "Searched cloud credentials"),
    ("cloud credentials", "Searched cloud credentials"),
...
def _falco_action_from_command(msg: str, fields: Dict[str, Any]) -> Optional[str]:
    ...
    if any(
        ...
        return "Searched cloud credentials"
